...
var Record = /** @class */ (function (_super) {
     ...
     * @memberOf Record
     */
    Record.prototype.toJsonApi = function (options) {
        var _this = this;
        ...
        var includeRefs = (options && options.include) || [];
        var refs = this['__refs'];
        utils_1.objectForEach(refs, function (key) {
            if (includeRefs.indexOf(key) < 0) {
                return;
            }
    ...
    Record.prototype.save = function (options, ignoreSelf) {
        ...
        var include = options.include, fields = options.fields;
        var data = this.toJsonApi({ include: include, fields: fields });
